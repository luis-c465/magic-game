...
new p5((p5) => {
  p5.preload = () => {
    ...
    playerTankCannonDefaultAnimation = p5.loadAnimation(
      new p5.SpriteSheet("assets/tanks.png", [
        {
          name: "stand",
  ...
  p5.setup = () => {
    ...
    playerGroup = new p5.Group();

    playerTankSprite = p5.createSprite(100, 284, 70, 94);
    ...
    playerTankCannon = p5.createSprite(100, 284, 70, 94);
  ...
  p5.mouseMoved = () => {
    const rotation = p5.atan2(
      p5.mouseY - playerTankCannon.position.y,
      p5.mouseX - playerTankCannon.position.x
    );
